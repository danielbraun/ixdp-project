d3 = function() {
	...
	function Zt(n, t, e, r) {
		var u;
		if (null == n) u = e * Fa / 2, r.point(-Fa, u), r.point(0, u), r.point(Fa, u), r.point(Fa, 0), r.point(Fa, -u), r.point(0, -u), r.point(-Fa, -u), r.point(-Fa, 0), r.point(-Fa, u);
		...
		function e(n) {
			...
			return {
				...
				point: function(s, h) {
					...
					if (!e && (l = c = d) && n.lineStart(), d !== c && (g = r(e, p), (Ft(e, g) || Ft(p, g)) && (p[0] += Ha, p[1] += Ha, d = t(p[0], p[1]))), d !== c) f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
					else if (o && e && a ^ d) {
						var v;
	...
	function mr(n, t) {
		...
		(e = Oo.exec(n)) && i > r; ++r) if (a = f[r], a.x == e[0]) {
	...
	function Tr(n, t) {
		var e;
		return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 * Fa) * Math.asin(1 / n) : (n = 1, e = t / 4),
		function(r) {
		...
		return u.invert = function(t) {
			...
			if (u.every(isFinite)) {
				var a = Math.log(t),
					...
					f = r(u[1]),
					s = t % 1 ? 2 : t;
				if (e === Ju) for (i.push(-Math.pow(t, -o)); o++ < c;) for (var h = s - 1; h > 0; h--) i.push(-Math.pow(t, -o) * h);
				else {
	...
	ca.touches = function(n, t) {
		...
		function t() {
			...
			r ? (i = r.apply(a, arguments), i = [i.x - h[0], i.y - h[1]]) : i = [0, 0], null == f && l(), o({
				type: "dragstart"
			})
		}
	...
	ca.ns = {
		...
		qualify: function(n) {
			var t = n.indexOf(":"),
				e = n;
			return t >= 0 && (e = n.substring(0, t), n = n.substring(t + 1)), Aa.hasOwnProperty(e) ? {
				space: Aa[e],
				local: n
			} : n
		}
	...
	Ba.forEach(function(n, t) {
		...
		var u = {}, i = ca.dispatch("progress", "load", "error"),
			a = {}, o = st,
	...
	ca.timer = function(n, t, e) {
		...
		var r = Ka[n.id];
		r && r.callback === n ? (r.then = e, r.delay = t) : Ka[n.id = ++Ga] = Wa = {
			callback: n,
			then: e,
			delay: t,
			next: Wa
	...
	(ca.geo.conicEqualArea = function() {
		...
		var e, r, u, i = ca.geo.conicEqualArea().rotate([98, 0]).center([0, 38]).parallels([29.5, 45.5]),
	...
	ca.geom.hull = function(n) {
		function t(n) {
			...
			var t, u, i, a, o, c, l, f, s, h, g, p, d = ft(e),
				m = ft(r),
				v = n.length,
				y = v - 1,
				M = [],
	...
	ca.ease = function(n) {
		...
		var e, r, u, i, a, o = {}, c = ca.dispatch("start", "tick", "end"),
			l = [1, 1],
			f = .9,
			s = Vo,
			h = Xo,
	...
	ca.layout.hierarchy = function() {
		...
		function t(n, r) {
			var u = n.children,
				a = 0;
			if (u && (o = u.length)) for (var o, c = -1, l = r + 1; ++c < o;) a += t(u[c], l);
	...
	ca.layout.histogram = function() {
		...
		normal: function(n, t) {
			...
			function() {
				var e, r, u;
				do e = Math.random() * 2 - 1, r = Math.random() * 2 - 1, u = e * e + r * r;
				while (!u || u > 1);
	...
	ca.svg.brush = function() {
		...
		function u() {
			...
			function g() {
				var n = u(),
					i = !1;
				v && (n[0] += v[0], n[1] += v[1]), E || (ca.event.altKey ? (m || (m = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]), k[0] = s[+(n[0] < m[0])][0], k[1] = s[+(n[1] < m[1])][1]) : m = null), w && p(n, o, 0) && (e(b), i = !0), S && p(n, c, 1) && (r(b), i = !0), i && (t(b), x({
					type: "brush",
					mode: E ? "move" : "resize"
				}))
			}
			...
			function d() {
				g(), b.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), ca.select("body").style("cursor", null), A.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), x({
					type: "brushend"
				}), l()
			}
			var m, v, y = this,
			...
			b.style("pointer-events", "none").selectAll(".resize").style("display", null), ca.select("body").style("cursor", M.style("cursor")), x({
				type: "brushstart"
			}), g(), l()
		}
